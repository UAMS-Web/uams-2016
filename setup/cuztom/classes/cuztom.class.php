...
class Cuztom
{
	public static $_reserved = array(
		'attachment', 'attachment_id', 'author', 'author_name', 'calendar', 'cat', 'category', 'category__and', 'category__in', 'category__not_in',
	...
	{
		return apply_filters( 'cuztom_beautify', ucwords( str_replace( '_', ' ', (string) $string ) ) );
	}

	public static function uglify( $string )
	{
		return apply_filters( 'cuztom_uglify', str_replace( '-', '_', sanitize_title( (string) $string ) ) );
	}
	...
	{
		if ( ! in_array( $term, self::$_reserved, true ) ) {
			return false;
		}
